...
router2.get('/spotify/login', function(req, res) {
  res.redirect('https://accounts.spotify.com/authorize?' +
    querystring.stringify({
      response_type: 'code',
      // client_id: process.env.SPOTIFY_CLIENT_ID,
      client_id: '613a9b0f2f88482e861cfaf59533a685',
...
router2.get('/spotify/callback', function(req, res) {
  ...
  let authOptions = {
    ...
    headers: {
      'Authorization': 'Basic ' + (new Buffer(
        ...
        '613a9b0f2f88482e861cfaf59533a685' + ':' + 'e2702e95e85b4f8aadc4758407e715b6'
      ).toString('base64'))
    },
    json: true
  }
